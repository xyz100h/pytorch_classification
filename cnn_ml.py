...
def classifier_pred(model_path, feature, id):
    ...
    submission.to_csv('/home/yangze/competition/102_flowers/weights/' + 'psdusvm_submission.csv', index=False, header=False)
...
if __name__ == "__main__":
    # #构建保存特征的文件夹
    feature_path = '/home/yangze/competition/102_flowers/features/'
...
######################################################################
    # #保存测试集特征
    # with open('/home/yangze/competition/102_flowers/54_data/svm.txt', 'r')as f:
    #     imgs = f.readlines()
